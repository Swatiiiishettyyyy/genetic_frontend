...
import { accountProfile } from "../../../shared/data/accountProfile.js";

export const dashboardProfile = {
  initials: accountProfile.initials,
  firstName: accountProfile.name?.split(" ")[0] ?? accountProfile.name,
};
...
export const dashboardModuleGroups = [
  ...
  },
  {
    ...
    modules: [
      ...
      { label: "Child Simulator", icon: welcomeDashboardIcons.childStimulator },
