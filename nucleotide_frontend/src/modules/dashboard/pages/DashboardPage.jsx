...
import dnaIcon from "../../../shared/assets/navbar/dna-mark.png";
...
function DashboardModule({ module }) {
  ...
  if (!module.href) {
    return (
      <span
        className="group flex w-[clamp(4.875rem,5.6vw,6.75rem)] shrink-0 cursor-default flex-col items-start gap-[clamp(0.625rem,0.85vw,0.875rem)] text-left opacity-70"
        aria-disabled="true"
        title="Coming soon"
      >
        {content}
...
function MobileDashboardModule({ module }) {
  ...
  if (!module.href) {
    return (
      <span
        className="group flex w-[6.5rem] cursor-default flex-col items-center gap-3 text-center opacity-70"
        aria-disabled="true"
        title="Coming soon"
      >
        {content}
