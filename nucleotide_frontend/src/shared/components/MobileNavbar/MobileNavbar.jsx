import dnaIcon from "../../assets/navbar/dna-mark.png";
import wordmark from "../../assets/navbar/wordmark.png";
      ...
      <div className="relative mx-auto flex h-16 w-full max-w-[128rem] items-center justify-between gap-3 px-[clamp(0.875rem,4vw,1.5rem)]">
        ...
        {showActions && (
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button type="button" className={iconButtonClass} aria-label="Cart" onClick={onCartClick}>
              <CartIcon />
            </button>
          </div>
        )}
