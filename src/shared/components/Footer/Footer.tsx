...
import footerLogo from '../../../modules/bloodtest/assets/figma/WhatsApp Image 2026-04-06 at 7.56.48 AM.jpeg'
import { useAuth } from '../../auth/AuthContext'
import { ga4CustomUserParams, trackGa4CustomEvent } from '../../../modules/bloodtest/utils/ga4CustomEvents'
      ...
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <div style={{ display: 'flex', gap: 14 }}>
            <a href="https://www.facebook.com/nucleotidehealthcare" aria-label="Facebook" style={iconStyle} onClick={() => trackGa4CustomEvent('social_icon_click', { linkText: 'Facebook', ...userParams })}>
            ...
            <a href="https://www.instagram.com/nucleotidehealthcare" aria-label="Instagram" style={iconStyle} onClick={() => trackGa4CustomEvent('social_icon_click', { linkText: 'Instagram', ...userParams })}>
            ...
            <a href="https://www.linkedin.com/company/nucleotidehealthcare" aria-label="LinkedIn" style={iconStyle} onClick={() => trackGa4CustomEvent('social_icon_click', { linkText: 'LinkedIn', ...userParams })}>
            ...
            <a href="https://youtube.com/@nucleotidehealthcare?si=9KYpX0d3Mp7Hlh8_" aria-label="YouTube" style={iconStyle} onClick={() => trackGa4CustomEvent('social_icon_click', { linkText: 'YouTube', ...userParams })}>
                ...
                {col.links.map(link =>
                  link.url === '#' ? (
                    <a key={link.text} href="#" style={{ fontSize: 13, color: '#9CA3AF', textDecoration: 'none' }}
                      onClick={() => trackGa4CustomEvent('footer_link_click', { linkText: link.text, sectionTitle: col.heading, ...userParams })}
      ...
      <div className="footer-bottom-shell">
        <div className="footer-bottom">
          ...
          <div className="footer-subscribe">
            ...
            />
            <button type="button" className="footer-subscribe-btn" onClick={() => trackGa4CustomEvent('subscribe_to_email', { linkText: 'Subscribe', ...userParams })}>
              Subscribe
            </button>
          </div>
        </div>
