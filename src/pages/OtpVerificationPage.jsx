...
import { AuthBackLink } from "../features/auth/components/AuthBackLink.jsx";
  ...
  return (
    <PageShell>
      <div className="relative isolate min-h-dvh overflow-hidden bg-white">
        ...
        <div className="relative z-10 mx-auto flex min-h-dvh w-full max-w-[90rem] flex-col px-[clamp(1rem,7vw,9.5625rem)] py-[clamp(1.5rem,5vw,4.8125rem)]">
          <AuthBackLink label={otpVerificationContent.backLabel} />
